  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      case `addcurrenttrack`: {
        ...
        //return susccess message
        return message.reply({embeds : [new MessageEmbed()
          .setTitle(`<a:yes:962755522627514368> Added ${track.title} onto the Queue \`${Name}\``.substr(0, 256))
      ...
      case `removesong`: {
        ...
        //return susccess message
        return message.reply({embeds :[new MessageEmbed()
          .setTitle(`<a:yes:962755522627514368> Deleted ${deletetrack.title} of the Queue \`${Name}\``.substr(0, 256))
      ...
      case `mix`: {
        ...
        //return susccess message
        return message.reply({embeds : [new MessageEmbed()
          .setTitle(`<a:yes:962755522627514368> Shuffled ${newtracks.length} Tracks of the Queue \`${Name}\``.substr(0, 256))
      ...
      case `removeduplicates`: {
        ...
        //return susccess message
        return message.reply({embeds : [new MessageEmbed()
          .setTitle(`<a:yes:962755522627514368> Removed ${counter} Tracks from the Queue \`${Name}\``.substr(0, 256))
      ...
      case `paly`: {
        ...
        let tempmsg = await message.reply({embeds : [new MessageEmbed()
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon && (es.footericon.includes("http://") || es.footericon.includes("https://")) ? es.footericon : client.user.displayAvatarURL() : null)
          .setFooter(client.getFooter(es))
          .setAuthor(eval(client.la[ls]["cmds"]["customqueues"]["savedqueue"]["variable89"]), "<a:loading:933964409661972491>")
