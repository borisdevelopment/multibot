  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    let ls = client.settings.get(message.guild.id, "language")
      ...
      const embed = new Discord.MessageEmbed()
        ...
        .addField('<a:arrow:962755778035478578> **Name**', "```"+json.name+"```", true)
        .addField("<a:arrow:962755778035478578> **Hex**",  "```"+json.hex+"```", true)
        .addField("<a:arrow:962755778035478578> **RGB**",  "```"+json.rgb+"```", true)
        .addField(`<a:arrow:962755778035478578> **${client.la[ls].cmds.info.color.brightershade}**`,  "```"+json.brightened +"```", true)
