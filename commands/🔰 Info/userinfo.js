  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {   
      ...
      try{
        ...
        embeduserinfo.setAuthor(handlemsg(client.la[ls].cmds.info.userinfo.author, { usertag: user.tag}), user.displayAvatarURL({ dynamic: true }), "https://discord.gg/zqjcg2vyrx")
