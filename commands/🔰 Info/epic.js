...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      if(!serverdata.verifychannel || serverdata.verifychannel.length < 5) return message.reply(`<:no:962755486938189844> Verification System not setupped! An Admin can enable it via: \`${prefix}setup-epicgamesverify\``);
