  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      .setAuthor(client.la[ls].cmds.info.serverinfo.author + " " +  message.guild.name, message.guild.iconURL({
        dynamic: true
      }), "https://discord.com/api/oauth2/authorize?client_id=960185136752766997&permissions=8&scope=bot%20applications.commands")
      ...
      embed.addField("**<:a_right:933701797032361984> Rules Channel:**", `${message.guild.rulesChannel ? `<#${message.guild.rulesChannelId}>`: "<:no:962755486938189844> \`No Channel\`"}`, true)
      embed.addField("**<:a_right:933701797032361984> Public Updates Channel:**", `${message.guild.publicUpdatesChannel ? `<#${message.guild.publicUpdatesChannelId}>`: "<:no:962755486938189844> \`No Channel\`"}`, true)
      embed.addField("**<:a_right:933701797032361984> AFK Channel:**", `${message.guild.afkChannel ? `<#${message.guild.afkChannelId}>`: "<:no:962755486938189844> \`No Channel\`"}`, true)
      ...
      if(boosts >= 14){
          embed.addField(`**<a:arrow:962755778035478578> Vanity:**`, `${message.guild.vanityURLCode ? `https://discord.gg/${message.guild.vanityURLCode}` : "<:no:962755486938189844> No Vanity-Invite"}`)
      }
      ...
      if(message.guild.banner) {
        ...
        .setTitle(`**<a:arrow:962755778035478578> SERVER BANNER:**`)
        ...
        let embed2 = new Discord.MessageEmbed()
        .setTitle(`**<a:arrow:962755778035478578> SERVER DISCOVERY SPLASH:**`)
