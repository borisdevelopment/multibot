          ...
          await tempmsg.channel.awaitMessages({
            ...
            .then(async collected => {
              try {
                ...
                message.reply({
                  embeds: [new Discord.MessageEmbed()
                    .setTitle(`<a:yes:962755522627514368> Set the TWITTER USER ID TO: \`${collected.first().content}\``.substr(0, 256))
                ...
                await tempmsg.channel.awaitMessages({
                  ...
                  .then(async collected => {
                    try {
                      ...
                      return message.reply({
                        embeds: [new Discord.MessageEmbed()
                          .setTitle(`<a:yes:962755522627514368> Set the TWITTER USER Name TO: \`${collected.first().content}\``.substr(0, 256))
