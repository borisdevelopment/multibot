  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      client.settings.ensure(message.guild.id, {
        suggest: {
          channel: "",
          approvemsg: `<a:yes:962755522627514368> Accepted Idea! Expect this soon.`,
          denymsg: `<:no:962755486938189844> Thank you for the feedback, but we are not interested in this idea at this time.`,
