      ...
      async function first_layer(){
        ...
        async function menuselection(menu) {
          ...
          if(menu?.values[0] == "Information"){
            ...
            await message.reply({ content: "<a:yes:962755522627514368> **The Current Anti-Nuke Settings**", embeds: [new MessageEmbed()
              .setColor(es.color)
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:leave:933722870734024724> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Bot add__ Whitelist (module)!**`.substr(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:leave:933722870734024724> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Kick/Ban__ Whitelist (module)!**`.substr(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:leave:933722870734024724> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Create Role__ Whitelist (module)!**`.substr(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:leave:933722870734024724> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Delete Role__ Whitelist (module)!**`.substr(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:leave:933722870734024724> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Channel Create__ Whitelist (module)!**`.substr(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:leave:933722870734024724> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Channel Delete__ Whitelist (module)!**`.substr(0, 2048))
                    ...
                    async function first_layer(){
                      ...
                      client.on('interactionCreate',  (menu) => {
                        if (menu?.message.id === menumsg.id) {
                          if (menu?.user.id === cmduser.id) {
                            if(used33) return menu?.reply({content: `<:no:962755486938189844> You already selected something, this Selection is now disabled!`, ephemeral: true})
            ...
            return menu?.reply({content: "<a:yes:962755522627514368> **Now using the Suggested Settings!**", embeds: [new MessageEmbed()
              .setColor(es.color)
              .setFooter(client.getFooter(es))
