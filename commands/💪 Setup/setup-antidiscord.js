        ...
        let menuoptions = [
          {
            ...
            emoji: `${client.settings.get(message.guild.id, `antidiscord.enabled`) ? "933742305398116363" : "962755522627514368"}`
          },
          {
            value: "Settings",
