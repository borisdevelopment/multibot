...
module.exports = {
  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
    ...
    try {
      ...
      .addField("<a:arrow:962755778035478578> PNG",`[\`LINK\`](${guild.iconURL({format: "png"})})`, true)
      .addField("<a:arrow:962755778035478578> JPEG",`[\`LINK\`](${guild.iconURL({format: "jpg"})})`, true)
      .addField("<a:arrow:962755778035478578> WEBP",`[\`LINK\`](${guild.iconURL({format: "webp"})})`, true)
