...
client.on("interactionCreate", async (btn) => {
  ...
  if (btn.customId == "restart_client") {
    ...
    btn.reply({
      content: "<a:yes:962755522627514368> **__Bot Has Been Succesfully Restarted.__**",
      ephemeral: true
    })
  ...
  if (btn.customId == "stop_client") {
    ...
    try {
      btn.reply({
        content: "<a:yes:962755522627514368> **Succesfully Stopped the bot. It May Take 5-6 Seconds To ShutDown The Bot..**",
        ephemeral: true
      })
      setTimeout(() => {
        process.exit()
