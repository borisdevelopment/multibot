  ...
  client.on("guildMemberAdd", async mem => {
    ...
    async function welcome(member) {
      ...
      if (invite && inviter) {
        ...
        invitemessage = `Invited by ${inviter.tag ? `**${inviter.tag}**` : `<@${inviter.id}>`}\n<:Like:934494916241948763> **${realinvites} Invite${realinvites == 1 ? "" : "s"}**\n[<:joines:933723116822220821> ${invites} Joins | <:leave:933722870734024724> ${leaves} Leaves | <:no:962755486938189844> ${fake} Fakes]`;
      } 
      else if(invite){
